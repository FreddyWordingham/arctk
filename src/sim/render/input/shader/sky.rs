...
use crate::{access, clone, display_field, display_field_ln, PerlinMap, Pos3};
...
impl Sky {
    ...
    access!(sun_pos, Pos3);
    clone!(sun_rad, f64);
    access!(noise, PerlinMap);

    /// Construct a new instance.
    #[inline]
    #[must_use]
    pub fn new(brightness: f64, sun_pos: Pos3, sun_rad: f64, noise: PerlinMap) -> Self {
...
impl Display for Sky {
    ...
    fn fmt(&self, fmt: &mut Formatter) -> Result {
        ...
        display_field!(fmt, "noise", &self.noise)
    }
}
