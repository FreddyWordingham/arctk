...
cp output/ch6/reactor/ppix/chelt/011_\{ala\}_diff.nc input/res/maps/init_ala_chelt.nc;
cp output/ch6/reactor/ppix/chelt/011_\{ppix\}_diff.nc input/res/maps/init_ppix_chelt.nc;
cp output/ch6/reactor/ppix/chelt/011_\{chelt\}_diff.nc input/res/maps/init_chelt_chelt.nc;
cp output/ch6/reactor/ppix/chelt/011_\{fe\}_diff.nc input/res/maps/init_fe_chelt.nc;
...
cp output/ch6/reactor/ppix/chelt_no/011_\{ala\}_diff.nc input/res/maps/init_ala_chelt_no.nc;
cp output/ch6/reactor/ppix/chelt_no/011_\{ppix\}_diff.nc input/res/maps/init_ppix_chelt_no.nc;
cp output/ch6/reactor/ppix/chelt_no/011_\{chelt\}_diff.nc input/res/maps/init_chelt_chelt_no.nc;
cp output/ch6/reactor/ppix/chelt_no/011_\{fe\}_diff.nc input/res/maps/init_fe_chelt_no.nc;
