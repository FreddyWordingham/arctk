...
mv output/inv/cartographer/tumour/thick/map_\{tumour\}.nc input/res/maps/tumour/thick.nc;
...
mv output/inv/cartographer/tumour/deep/map_\{tumour\}.nc input/res/maps/tumour/deep.nc;
