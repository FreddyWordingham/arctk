...
cp output/tmp/init_ala.nc input/res/maps/;
babbage output/tmp input/ ch4/babbage/build_map_diff_ala.json5;
cp output/tmp/diff_ala.nc input/res/maps/;
...
cp output/tmp/multipliers_shallow.nc input/res/maps/;
cp output/ch4/cartographer/tumour/shallow/map_\{tumour\}.nc input/res/maps/tumour_shallow.nc;
reactor output/ch4/reactor/ppix/shallow input/ ch4/reactor/ppix/shallow.json5;
cp output/ch4/reactor/ppix/shallow/015_\{ppix\}_diff.nc input/res/maps/init_ppix_shallow.nc;
cp output/ch4/reactor/ppix/shallow/015_\{ala\}_diff.nc input/res/maps/init_ala_shallow.nc;
...
cp output/tmp/multipliers_thick.nc input/res/maps/;
cp output/ch4/cartographer/tumour/thick/map_\{tumour\}.nc input/res/maps/tumour_thick.nc;
reactor output/ch4/reactor/ppix/thick input/ ch4/reactor/ppix/thick.json5;
cp output/ch4/reactor/ppix/thick/015_\{ppix\}_diff.nc input/res/maps/init_ppix_thick.nc;
cp output/ch4/reactor/ppix/thick/015_\{ala\}_diff.nc input/res/maps/init_ala_thick.nc;
...
cp output/tmp/multipliers_deep.nc input/res/maps/;
cp output/ch4/cartographer/tumour/deep/map_\{tumour\}.nc input/res/maps/tumour_deep.nc;
reactor output/ch4/reactor/ppix/deep input/ ch4/reactor/ppix/deep.json5;
cp output/ch4/reactor/ppix/deep/015_\{ppix\}_diff.nc input/res/maps/init_ppix_deep.nc;
cp output/ch4/reactor/ppix/deep/015_\{ala\}_diff.nc input/res/maps/init_ala_deep.nc;
